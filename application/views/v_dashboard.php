          ...
          <div class="box box-widget widget-user">
            ...
            <div class="box-footer">
              <div class="row">
                ...
                ?>
                <?php echo $avatar; ?>
                    <h5 class="description-header">Hai gais! Ini Sistem Penjualan Tempe</h5>
                    <span class="description-text"><?php echo button('load_silent("kelola/kelola_user/show_editForm_user/'.from_session('id').'","#content")','Update Profil','btn bg-blue','data-toggle="tooltip" title="Update Profil"');?> 
						</span>
                  </div>
                  <!-- /.description-block -->
                </div>
